...
function InternshipCoordinatorProfile() {
    ...
    <div className="bg-white">
      <div>
        ...
        <Transition.Root show={mobileNavOpen} as={Fragment}>
          <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setMobileNavOpen}>
            <Transition.Child
              as={Fragment}
        ...
        <main className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="border-b border-gray-200 pb-10">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">Profile</h1>
          </div>
...
export default InternshipCoordinatorProfile;
