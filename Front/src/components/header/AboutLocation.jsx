      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <h3 className="text-lg font-medium text-gray-900">Chargia</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900">Tunis</h3>
              <p className="mt-2 text-base text-gray-500">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900">lafayett</h3>
              <p className="mt-2 text-base text-gray-500">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900">Urban Nord</h3>
              <p className="mt-2 text-base text-gray-500">
